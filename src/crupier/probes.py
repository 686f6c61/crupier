...
class CapabilityProbeRunner:
    ...
    def _probe_text_basic(self, card: CapabilityCard) -> ProbeResult:
        ...
        request = RequestEnvelope(
            ...
            constraints={"max_output_tokens": 16, "temperature": 0, "timeout_seconds": 60},
        )
        return self._call_and_check(
            ...
            prompt=prompt,
            request=request,
            check=lambda text: "crupier-probe-ok" in text.strip().lower(),
    ...
    def _probe_json_instruction(self, card: CapabilityCard) -> ProbeResult:
        ...
        request = RequestEnvelope(
            ...
            constraints={"max_output_tokens": 64, "temperature": 0, "timeout_seconds": 60},
        )
    ...
    def _probe_max_output_param(self, card: CapabilityCard) -> ProbeResult:
        ...
        return self._call_and_check(
            ...
            metadata={"capability": "max_output_control", "requested_max_output_tokens": 16},
        )
    ...
    def _probe_native(
        ...
        *,
        ...
        request = RequestEnvelope(
            ...
            constraints={"max_output_tokens": 128, "temperature": 0, "timeout_seconds": 60},
        )
