...
from crupier.errors import CrupierBudgetExceededError, CrupierToolApprovalRequired, CrupierProviderUnavailableError


class FakeAdapter:
    provider = "openai"

    def __init__(self, provider="openai", *, fail=False, outputs=None):
